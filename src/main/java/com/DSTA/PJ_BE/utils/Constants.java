...
public class Constants {
	...
	public static final String ACCOUNT_NOT_FOUND = "Mã người dùng không tồn tại!";
	...
	public static final String NEW_PASSWORD_ERROR = "Độ dài mật khẩu mới ít nhất phải 3 kí tự!";

	public static final String OLD_PASSWORD_ERROR = "Mật khẩu cũ không chính xác!";

	public static final String CHANGE_PASSWORD_SUCCESS = "Thay đổi mật khẩu thành công!";

	public static final String ADMIN_ID_ERROR = "Mã quản trị viên không hợp lệ!";

	public static final String ACCOUNT_INVALID = "Không tồn tại người dùng!";

	public static final String INVALID_DATE_FORMAT = "Không đúng định dạng ngày!";
	...
	public static final String VERIFY_OTP_FAIL = "Mã OTP không đúng";
